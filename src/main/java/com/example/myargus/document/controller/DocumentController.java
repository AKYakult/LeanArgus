package com.example.myargus.document.controller;
...
import com.example.myargus.document.model.vo.DocumentDownloadVO;
...
import com.example.myargus.document.service.DocumentDeleteService;
import com.example.myargus.document.service.DocumentDownloadService;
import com.example.myargus.document.service.DocumentPreviewService;
import com.example.myargus.document.service.DocumentQueryService;
import com.example.myargus.document.service.DocumentUploadService;
...
public class DocumentController {
    ...
    public ApiResponse<UploadInitResponse> initUpload(
        ...
        return ApiResponse.ok(documentUploadService.initUpload(request, uploadRequest));
    }
    ...
    public ApiResponse<UploadStatusResponse> uploadChunk(
        ...
        return ApiResponse.ok(documentUploadService.getUploadStatus(request, uploadRequest.uploadId()));
    }
    ...
    public ApiResponse<UploadStatusResponse> getUploadStatus(
            ...
            HttpServletRequest request) {
        return ApiResponse.ok(documentUploadService.getUploadStatus(request, uploadId));
    }
    ...
    public ApiResponse<Long> completeUpload(
            @PathVariable String uploadId,
            HttpServletRequest request) {
        return ApiResponse.ok(documentUploadService.completeUpload(request, uploadId));
    }
    ...
    public ApiResponse<Long> uploadDocument(
        ...
        return ApiResponse.ok(documentUploadService.uploadDocument(user.userId(), uploadRequest));
    }
    ...
    public ApiResponse<List<DocumentListItemVO>> listDocuments(
        ...
        return ApiResponse.ok(documentQueryService.listDocuments(query));
    }
    ...
    public ApiResponse<DocumentPreviewVO> previewDocument(
            ...
            @RequestParam Long groupId) {
        CurrentUserService.CurrentUser user = currentUserService.requireBusinessUser();
        return ApiResponse.ok(documentPreviewService.previewDocument(user.userId(), groupId, documentId));
    }
