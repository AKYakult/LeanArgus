package com.example.myargus.engine.storage;
...
public interface ObjectStorageService {
     ...
     * @throws com.example.myargus.common.exception.BusinessException 读取失败时抛出（如对象不存在、权限不足、网络异常）
     */
     ...
     * @throws com.example.myargus.common.exception.BusinessException 上传失败时抛出
     */
     ...
     * @throws com.example.myargus.common.exception.BusinessException 合并失败时抛出
     */
     ...
     * @throws com.example.myargus.common.exception.BusinessException 删除失败时抛出（如权限不足、网络异常）
     */
