package com.example.myargus.group.mapper;

import com.baomidou.mybatisplus.core.mapper.BaseMapper;
import com.example.myargus.group.model.entity.Group;
import com.example.myargus.group.model.entity.GroupInvitation;
...
public interface GroupMembershipMapper extends BaseMapper<Group> {
    ...
    /** 插入群组并返回自增主键 */
    Long insertGroupReturningId(@Param("groupCode") String groupCode, @Param("groupName") String groupName, @Param("description") String description, @Param("ownerUserId") Long ownerUserId,
    ...
    /** 查询用户发出的邀请 */
    List<MySentInvitationResponse> selectSentInvitationsByInviterUserId(@Param("inviterUserId") Long inviterUserId);
